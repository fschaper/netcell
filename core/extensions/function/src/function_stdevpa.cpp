...
/*!
 * \brief
 * Estimates standard deviation of an entire population.
 *
 ...
 *  Vali Nitu <vali@yalos-solutions.com>
 */
class stdevpa_alg : public error_handling_alg
{
private:
    size_t      m_count;
    double      m;
    double      q;
public:
    stdevpa_alg() : m_count( 0 ), m( 0.0 ), q( 0.0 ) {}
    ...
    operator variant() {
        ...
        return ( variant( q = std::sqrt( q / ( m_count ) ) ) );
    }
