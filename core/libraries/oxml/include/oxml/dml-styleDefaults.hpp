...
#ifndef DML_STYLEDEFAULTS_HPP
#define DML_STYLEDEFAULTS_HPP
...
namespace drawingml
{
	...
	{
	public:
		poptional< CT_DefaultShapeDefinition > spDef;
		poptional< CT_DefaultShapeDefinition > lnDef;
		poptional< CT_DefaultShapeDefinition > txDef;
		poptional< CT_OfficeArtExtensionList > extLst;
	};
