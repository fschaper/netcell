...
#ifndef DML_SHAPE3DCAMERA_READERS_HPP
#define DML_SHAPE3DCAMERA_READERS_HPP
...
namespace drawingml
{
	namespace xio
	{
		...
		class ST_FOVAngle_reader;
		class CT_Camera_reader;

		class ST_FOVAngle_reader : public ST_Angle_reader
		{
		protected:
			ST_FOVAngle* t() { return static_cast<ST_FOVAngle*>(target()); }
		};

		class CT_Camera_reader : public type_reader
		{
