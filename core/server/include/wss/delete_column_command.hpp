 ...
 * Frieder Hofmann <frieder.hofmann@jedox.com>
 */
class WSS_MODULE delete_column_command
    : public abstract_undoable_command
{
public:
    typedef void result_type;

    delete_column_command( session& s, unsigned int column, unsigned int column_count  );
    ...
    DECLARE_CLONEABLE( delete_column_command );
