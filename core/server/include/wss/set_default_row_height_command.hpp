 ...
 * Florian Schaper <florian.schaper@jedox.com>
 */
class WSS_MODULE set_default_row_height_command
    : public abstract_undoable_command
{
public:
    typedef void result_type;

    set_default_row_height_command( session& s, unsigned int row_height );
    ...
    * Florian Schaper <florian.schaper@jedox.com>
    */
    DECLARE_CLONEABLE( set_default_row_height_command );
