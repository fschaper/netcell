...
/*!
 * \brief
 * workbook version command
 *
 * \author
 * Vali Nitu <vali@yalos-solution.com>
 */
class WSS_MODULE get_workbook_version_command
    : public base_command<i_command>
{
public:
    typedef std::string result_type;

    get_workbook_version_command( session& s, const uuid_type& id );
...
private:
    ...
    DECLARE_CLONEABLE( get_workbook_version_command );
};
