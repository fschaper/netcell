...
#ifndef DML_GRAPHICALOBJECT_READERS_HPP
#define DML_GRAPHICALOBJECT_READERS_HPP
...
namespace drawingml
{
	namespace xio
	{
		...
		class CT_GraphicalObjectData_reader;
		class CT_GraphicalObject_reader;
		class dml_graphicalObject_reader;

		class CT_GraphicalObjectData_reader : public type_reader
		{
		protected:
		...
		class CT_GraphicalObject_reader : public type_reader
		{
			auto_type_reader< CT_GraphicalObjectData_reader > _graphicData_reader;
		protected:
		...
		class dml_graphicalObject_reader : public type_reader
		{
