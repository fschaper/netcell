 ...
 * the arrays/ranges must be the of the same size
 *
...
variant traverse2( function_parameter& parameters, T& algorithm )
{
    ...
    // If array1 and array2 have a different number of data points return the #N/A error value.
