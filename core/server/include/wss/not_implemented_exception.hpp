...
/*!
 * \brief
 * thrown when the requested method was not implemented.
 *
 * \author
 * Florian Schaper <florian.schaper@jedox.com>
 */
class WSS_MODULE not_implemented_exception
...
public:
    ...
    not_implemented_exception()
        : wss_runtime_exception( "the requested method was not implemented!" ) {}
