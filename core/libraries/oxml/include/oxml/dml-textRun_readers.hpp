...
#ifndef DML_TEXTRUN_READERS_HPP
#define DML_TEXTRUN_READERS_HPP
...
namespace drawingml
{
	namespace xio
	{
		...
		class CT_RegularTextRun_reader;

		class CT_RegularTextRun_reader : public type_reader
		{
			auto_type_reader< CT_TextCharacterProperties_reader > _rPr_reader;
		protected:
			CT_RegularTextRun* t() { return static_cast<CT_RegularTextRun*>(target()); }
