...
#ifndef DML_SHAPE3DSCENE_WRITERS_HPP
#define DML_SHAPE3DSCENE_WRITERS_HPP
...
namespace drawingml
{
	namespace xio
	{
		...
		class CT_Scene3D_writer;

		class CT_Scene3D_writer : public type_writer
		{
			auto_type_writer< CT_Camera_writer > _camera_writer;
			auto_type_writer< CT_LightRig_writer > _lightRig_writer;
			auto_type_writer< CT_Backdrop_writer > _backdrop_writer;
