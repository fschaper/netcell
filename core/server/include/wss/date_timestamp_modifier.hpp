...
namespace logging
{
    /*!
     * \brief
     * add date time information to log message.
     *
     * \remarks
     * the date time format can be customized using the
     * format method.
     *
     * \author
     * Florian Schaper <florian.schaper@jedox.com>
     */
    class date_timestamp_modifier
    ...
    /*!
     * \brief
     * creator for the date_timestamp modifier.
     *
     * \author
     * Florian Schaper <florian.schaper@jedox.com>
     */
    class date_timestamp_modifier_creator
