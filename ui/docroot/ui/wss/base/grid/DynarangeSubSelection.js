 ...
 *
 * \version
 * SVN: $Id: DynarangeSubSelection.js 4776 2011-03-28 14:25:45Z predragm $
 *
 */
...
Jedox.wss.grid.DynarangeSubSelection = (function ()
{
	...
	// class constructor
	return function (startCoords, endCoords, sheet, parent, parentStartPoint, parentEndPoint)
	{
		Jedox.wss.grid.DynarangeSubSelection.parent.constructor.call(this, startCoords, sheet);
		...
		// constructor code
		var that = this;
		this._ranges = [new Jedox.wss.grid.DynarangeSubRange(parent, that, startCoords, endCoords, parentStartPoint, parentEndPoint)];
...
// DynarangeSubSelection extends Selection
Jedox.util.extend(Jedox.wss.grid.DynarangeSubSelection, Jedox.wss.grid.Selection);
