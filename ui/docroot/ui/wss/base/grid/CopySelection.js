 ...
 *
 * \version
 * SVN: $Id: CopySelection.js 4776 2011-03-28 14:25:45Z predragm $
 *
 */
...
Jedox.wss.grid.CopySelection = (function ()
{
	...
	{
		Jedox.wss.grid.CopySelection.parent.constructor.call(this, startCoords, sheet);
...
// CopySelection extends Selection
...
clsRef.prototype.addRange = function(startPoint, endPoint) {
	return this._ranges.push(new Jedox.wss.grid.CopyRange(this, startPoint, endPoint));
};
