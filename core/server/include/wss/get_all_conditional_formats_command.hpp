...
/*!
 * \brief
 * get all conditional formats in a worksheet
 *
 * \author
 * Frieder Hofmann <frieder.hofmann@jedox.com>
 */
class WSS_MODULE get_all_conditional_formats_command
    : public base_command<i_command>
{
public:
    typedef const get_conditionalformat_list_type& result_type;

    get_all_conditional_formats_command( session& s, const shared_worksheet_type& ws );
    ...
    DECLARE_CLONEABLE( get_all_conditional_formats_command );
private:
