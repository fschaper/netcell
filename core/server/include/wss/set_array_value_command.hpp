...
/*!
 * \brief
 * set array value command.
 *
 * \author
 * Florian Schaper <florian.schaper@jedox.com>
 */
class WSS_MODULE set_array_value_command
    : public abstract_undoable_command
{
public:
    typedef void result_type;

    set_array_value_command( session& s, const sheet_range& p, const variant& v );

    virtual void execute();

    virtual void un_execute();

    DECLARE_CLONEABLE( set_array_value_command );
