...
named_formula_not_found_exception::named_formula_not_found_exception( const uuid_type& id )
    : wss_runtime_exception( "named formula not found! id: '" + boost::lexical_cast<std::string>( id ) + "'" ) {}
